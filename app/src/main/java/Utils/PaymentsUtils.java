...
public class PaymentsUtils {
    ...
    public static JSONObject baseConfigurationJson() throws JSONException {
    ...
    public static PaymentsClient createPaymentsClient(Activity activity) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(Utils.Constants.PAYMENTS_ENVIRONMENT).build();
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        if (Utils.Constants.DIRECT_TOKENIZATION_PARAMETERS.isEmpty()
                || Utils.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty()
                || Utils.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY == null
                || Utils.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME") {
        ...
        JSONObject parameters = new JSONObject(Utils.Constants.DIRECT_TOKENIZATION_PARAMETERS);
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(Utils.Constants.SUPPORTED_NETWORKS);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(Utils.Constants.SUPPORTED_METHODS);
    }
...
//        // Optionally, you can add billing address/phone number associated with a CARD payment method.
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", Utils.Constants.COUNTRY_CODE);
        transactionInfo.put("currencyCode", Utils.Constants.CURRENCY_CODE);
    ...
    public static Optional<JSONObject> getPaymentDataRequest(String price) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(Utils.Constants.SHIPPING_SUPPORTED_COUNTRIES);
