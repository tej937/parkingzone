...
public class TransactionPage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    DrawerLayout mDraw;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.parking) {
            Intent intent = new Intent(TransactionPage.this, ParkingData.class);
            startActivity(intent);
            finish();
            return true;
        } else if (id == R.id.setting) {
            Intent intent = new Intent(TransactionPage.this, SettingOwnerPage.class);
            startActivity(intent);
            finish();
            return true;
            ...
            signout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    myDialog.dismiss();
                    Intent intent = new Intent(TransactionPage.this, Selection.class);
                    int flag = 0;
            ...
            Intent intent = new Intent(TransactionPage.this, OwnerHomePage.class);
            startActivity(intent);
            finish();
            return true;
        } else
